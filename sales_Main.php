...
<body>
	<div class="w3-top" id="Header">
		<div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    		<h3 id="company-title">Perishable Management System</h3>
  		</div>
	</div>
	...
	<div class="w3-main" style="margin-left:250px">
		...
		<?php echo $message ?>
			  ...
			  <form action="" method="post">
                ...
                <span id="Products">Enter order mode: - <span style="margin-left: 140px"></span> <input type='text' name="status" id="status" class="register-field" placeholder="status"></span><br><br>
