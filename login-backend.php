...
if(isset($_POST["email"]) && isset($_POST["password"])){
	...
	if($count == 1){
            ...
            exit;
                ...
                }else if($_POST["email"] =="supplier@gmail.com" && $_POST["password"] =='supplier@123' ){
                    $_SESSION["sales_id"] = "1";
                    $_SESSION["sales_name"] = "Inventory";
                    echo "<script> location.href='sales_Main.php'; </script>";
                }
                else if($_POST["email"] =="shipment@gmail.com" && $_POST["password"] =='shipment@123' ){
                    $_SESSION["ship_id"] = "1";
                    $_SESSION["ship_name"] = "Shipement";
                    echo "<script> location.href='ship_Main.php'; </script>";
                }else{
                    echo "login_failed"; // Notify about login failure
